...
- 실행시간(UTC): **2026-08-09 03:00:50**

## Commodity Regime

- WTI ref (CL=F): 78.18 / 5D -7.67%
- Brent ref (BZ=F): 83.55 / 5D -7.29%
- Brent Tier: **80-90**
- Brent-WTI spread: 5.37
- Gas ref (NG=F): 2.66 / 5D -3.09%
...
- SilverMarginGate: SI=63.332001 / watch>=32.0:True / entry>=35.0:True
