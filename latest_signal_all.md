...
- 실행시간(UTC): **2026-07-20 03:00:49**

## Commodity Regime

- WTI ref (CL=F): 83.45 / 5D 6.80%
- Brent ref (BZ=F): 90.08 / 5D 8.14%
- Brent Tier: **>=90**
- Brent-WTI spread: 6.63
...
- 데이터 기준일(주가): **2026-07-19**
- 실행시간(UTC): **2026-07-20 03:00:52**
...
- SilverMarginGate: SI=57.424999 / watch>=32.0:True / entry>=35.0:True
